...
@section('content')
    ...
    <div class="container mx-auto px-6 py-3  mr-8 bg-[#EEF6FF]">
        ...
        <div>
            <div
                class="bg-[#7F7F7F] text-white rounded-full px-4 py-2 mt-4 hover:bg-[#7F7F7F] hover:scale-105 transition-transform duration-300">
