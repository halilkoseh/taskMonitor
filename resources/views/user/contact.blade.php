        ...
        <div class="w-full md:w-1/2 mt-10 md:mt-0 space-y-8 md:ml-16">
            ...
            <ul class="space-y-4 text-[#535353]">
                ...
                <li class="flex items-center text-lg">
                    ...
                    <span><a href="tel:1-212-555-5555" class="hover:text-blue-400">+90 (538) 200 44 66
                ...
                <li class="flex items-center text-lg">
                    ...
                    <span><a href="mailto:hitmeup@gmail.com" class="hover:text-blue-400">info@taskmonitor.com.tr
