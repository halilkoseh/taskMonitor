                                            ...
                                            @if ($task->attachments)
                                                <a href="{{ route('attachments.download', ['filename' => basename($task->attachments)]) }}"
                                                    class="text-gray-600 hover:text-blue-500"><i
                                                        class="fa-solid fa-paperclip mr-2"></i></a>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function handleDrop(event) {
                ...
                const currentStatus = taskCard.parentElement.dataset.status; // Mevcut durum

                // Eğer yeni durum "Onaylandı" ise ve kullanıcı yetkili değilse işlemi engelle
                ...
                // Eğer görev "Onay Bekliyor"dan "Onaylandı"ya gidiyorsa ve yetkili değilse engelle
                if (currentStatus === "Atandı" && newStatus === "Revize") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi onaylamak için yetkiniz yok!");
                        return;
                    }
                ...
                // Eğer görev "Onay Bekliyor"dan "Revize"ye gidiyorsa ve yetkili değilse engelle
                if (currentStatus === "Devam Ediyor" && newStatus === "Revize") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                }


                if (currentStatus === "Revize" && newStatus === "Atandı") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Revize" && newStatus === "Devam Ediyor") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Onay Bekliyor" && newStatus === "Revize") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Onaylandı" && newStatus === "Atandı") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Onaylandı" && newStatus === "Devam Ediyor") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Onaylandı" && newStatus === "Revize") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
                ...
                if (currentStatus === "Onaylandı" && newStatus === "Onay Bekliyor") {
                    if (window.currentUser.is_admin !== 1 && window.currentUser.is_admin !== 2) {
                        alert("Bu görevi revizeye göndermek için yetkiniz yok!");
                        return;
                    }
